...
-- SELECT * FROM NAMETABLE - Mostra tudo o que existe dentro da tabela
SELECT * FROM debitcard;

-- Alterar a Estrutura
ALTER TABLE debitcard DROP COLUMN organization; 
...
INSERT INTO store(pk_sid, name, streetAddr, province, city, customerGrade, startDate) VALUES(8,'Choby Collection','Quebec','Montreal','No.2012 Sanguinet',4,'2006-5-30');
INSERT INTO store(pk_sid, name, streetAddr, province, city, customerGrade, startDate) VALUES(10,'BestBuy','British Columbia','Vancouver','No.20 ShineStreet',5,'2002-8-05');
INSERT INTO store(pk_sid, name, streetAddr, province, city, customerGrade, startDate) VALUES(39,'CoolGuy','Quebec','Montreal','No.1023 St-Catherine',3,'2012-2-24');
INSERT INTO store(pk_sid, name, streetAddr, province, city, customerGrade, startDate) VALUES(77,'Your Favorite','Ontario','Toronto','No.3022 Saint Denis',4,'2015-7-25');
INSERT INTO store(pk_sid, name, streetAddr, province, city, customerGrade, startDate) VALUES(218,'American Eagle','Quebec','Quebec city','No.5 Berri Street',2,'2004-11-17');
...
SHOW COLUMNS FROM ServicePoint;

-- Altera a o tipo de dados de uma informação
-- ALTER TABLE servicePoint MODIFY COLUMN startTime VARCHAR(20); -- Alterou o tipo de dado TIME para Varchar
-- ALTER TABLE servicePoint MODIFY COLUMN endTime VARCHAR(20);  -- Alterou o tipo de dado TIME para Varchar
...
-- Altera a o tipo de dados de uma informação
-- ALTER TABLE Comments MODIFY COLUMN creationTime DATE; -- Alterou o tipo de Varchar para Date
ALTER TABLE Comments MODIFY COLUMN content VARCHAR(500); -- Aumentou o número de caracteres do Varchar
...
-- Mostra todas as colunas da tabela
SHOW COLUMNS FROM saveToShoppingCart;

-- Altera a o tipo de dados de uma informação
-- ALTER TABLE saveToShoppingCart MODIFY COLUMN addTime DATE;
-- Alterou o tipo TIME para DATE

INSERT INTO saveToShoppingCart VALUES(5,1,'2017-02-21',1);
INSERT INTO saveToShoppingCart VALUES(5,2,'2016-09-18',1);
INSERT INTO saveToShoppingCart VALUES(18,3,'2014-03-22',2);
INSERT INTO saveToShoppingCart VALUES(12,4,'2017-01-23',1);
INSERT INTO saveToShoppingCart VALUES(24,5,'2016-12-27',2);
INSERT INTO saveToShoppingCart VALUES(41,6,'2015-05-30',1);
INSERT INTO saveToShoppingCart VALUES(9,7,'2016-02-19',4);
INSERT INTO saveToShoppingCart VALUES(18,8,'2012-01-20',1);
...
-- Tabela Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount)
SHOW COLUMNS FROM Orders;

INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(76023921,'Paid','2016-09-18',315);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(23924831,'Paid','2014-03-22',174);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(87291231,'Unpaid','2017-01-23',102);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(58293123,'Unpaid','2016-12-27',928);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(12992012,'Paid','2015-05-30',203);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(59203012,'Paid','2017-02-12',87);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(91027482,'Unpaid','2016-12-27',187);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(72839301,'Unpaid','2015-02-13',293);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(93042135,'Paid','2015-08-22',52);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(74892932,'UnPaid','2016-02-19',77);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(83921201,'Paid','2017-01-03',301);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(73919231,'Paid','2014-02-11',20);
INSERT INTO Orders(pk_orderNumber, paymentStatus, creationTime, totalAmount) VALUES(84821231,'Paid','2014-11-02',18);

SELECT * FROM Orders;

-- Tabela Contain
SHOW COLUMNS FROM Contain;
...
INSERT INTO Contain VALUES(82921201,4,4); -- Este dado não existe na tabela Orders
